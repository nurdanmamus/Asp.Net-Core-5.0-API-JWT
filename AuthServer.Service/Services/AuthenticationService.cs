...
namespace AuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService 
    {
        ...
        public AuthenticationService(IOptions<List<Client>> optionsClient,
            ITokenService tokenService, UserManager<UserApp> userManager, 
        ...
        public async Task<Response<TokenDto>> CreateTokenAsync(LoginDto loginDto) 
        {
            ...
            if (userRefreshToken==null) //eğer refresh token yoksa yeniden oluşturulacak
            {
            ...
            else //refresh token varsa güncellenecek 
            {
